...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic | Horizontal Timeline</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <#include "../index/indexSidebar.ftl" />
            <!-- END SIDEBAR -->
            <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Horizontal Timeline
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                                        ...
                                        <div class="timeline">
                                            <div class="events-wrapper">
                                                <div class="events">
                                                    <ol>
                                                        <li>
                                                            <a href="#0" data-date="16/01/2014" class="border-after-red bg-after-red selected">16/01/2014</a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a href="#0" data-date="30/08/2014" class="border-after-red bg-after-red">30/08/2014</a>
                                                        </li>
                                                        <li>
                                                            <a href="#0" data-date="15/09/2014" class="border-after-red bg-after-red">15/09/2014</a>
                                                        </li>
                                                        <li>
                                                            <a href="#0" data-date="01/11/2014" class="border-after-red bg-after-red">01/11/2014</a>
                                                        </li>
                                                        <li>
                                                            <a href="#0" data-date="10/12/2014" class="border-after-red bg-after-red">10/12/2014</a>
                                                        </li>
                                                        <li>
                                                            <a href="#0" data-date="19/01/2015" class="border-after-red bg-after-red">19/01/2015</a>
                                                        </li>
                                                        <li>
                                                            <a href="#0" data-date="03/03/2015" class="border-after-red bg-after-red">03/03/2015</a>
                                                        </li>
                                                    </ol>
        ...
        <!-- END CONTAINER -->
        <!-- BEGIN FOOTER -->
        <#include "../index/indexFooter.ftl" />
        <!-- END FOOTER -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="${application.getContextPath()}/assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
    </body>
